...
int main(int argc, char **argv)
{
  ...
  ////////////////  image transport ///////////////////////////
   ...
   sensor_msgs::ImagePtr msg = cv_bridge::CvImage(std_msgs::Header(), "bgr8", mat_image_org_color).toImageMsg();
   ...
   { 
     ...
     */
     ...
     else
     {
      ...
      msg = cv_bridge::CvImage(std_msgs::Header(), "bgr8", mat_image_org_color).toImageMsg();  
      pub.publish(msg);
